...
async function generateIcons() {
  ...
  // 3. Mac/Standalone icon (512x512, transparent with rounded rect)
  try {
    const size = 512;
    const innerSize = 400;
